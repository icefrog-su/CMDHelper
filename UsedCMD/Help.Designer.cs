namespace UsedCMD
{
    partial class Help
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label3.Text = "     在使用过程中,如果出现问题,请选确保键入\r\n命令在系统CMD中可以正确执行,测试方法为:\r\n[WIN+R]键入CMD,在打开的CMD窗口中输入\r\n需要测" +
    "试的命令。如果在cmd中能够正确执行\r\n则请确保本应用被使用管理员权限打开\r\n\r\n";
            // 
            // label4
            // 
            ...
            this.label4.Text = "Copyright ©2016 [ICE FROG] Powered By [CMD Helper]";
            // 
            // Help
            // 
